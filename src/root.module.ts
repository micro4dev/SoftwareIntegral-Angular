...
import { SoftwareIntegralCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'SoftwareIntegral',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for SoftwareIntegral',
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        SoftwareIntegralCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule,
